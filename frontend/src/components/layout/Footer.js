                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="space-y-4">
                        <div className="flex items-center">
                            <FaTags className="text-blue-400 mr-2" size={24} />
                            <h3 className="text-xl font-bold">Mini E-Commerce</h3>
                        </div>
                        <p className="text-gray-300">Your one-stop shop for all your online shopping needs with the best prices and quality products.</p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link href="/customer" className="text-gray-300 hover:text-white transition-colors">
                                    My Account
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        <h3 className="text-lg font-bold mb-4 text-blue-400">Customer Service</h3>
                        <ul className="space-y-3">
                            <li>
                                <Link href="#" className="text-gray-300 hover:text-white transition-colors">
                                    Contact Us
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="flex items-center">
                                ...
                                <span className="text-gray-300">info@miniecommerce.com</span>
                            </li>
                            <li className="flex items-start">
                                <FaMapMarkerAlt className="text-blue-400 mr-3 mt-1" />
                                <span className="text-gray-300">123 E-Commerce St, Web City, Digital State, 12345</span>
                            </li>
                        </ul>
                    </div>
                </div>
